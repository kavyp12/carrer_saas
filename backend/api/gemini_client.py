...
# from dotenv import load_dotenv  # Add dotenv to load .env files
...
#         if not api_key:
#             raise ValueError("Missing GEMINI_API_KEY in environment variables. Please set GEMINI_API_KEY in your .env file.")
